...
//typedef struct timeTag timeTag;
//
//struct timeTag {
//
//	char label;
...
extern void setupRealTimeTimer( void );
extern void updateTime( void );
extern void setTimeTag( unsigned int msToNextEvent , timeTag *eventTag );
extern char eventDue( timeTag *eventTag );
